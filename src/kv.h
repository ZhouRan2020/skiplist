...
template<typename T> class Less {
    public:
    bool operator () (const T & a , const T & b) const {//to indicate this member function wont modify data in the class
        return a < b;
    }
};

template<typename K, typename V,typename Comp = Less<K>> class skip_list {
    ...
    node *head, *tail;//declaration == declaration specifier seqence + declarator (declaration operator+id)
    Comp less;
